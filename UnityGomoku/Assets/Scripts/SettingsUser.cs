	...
	public class SettingsUser : MonoBehaviour {
		...
		void Start () {
			ia_lvls = new string[] {"IA te donne la partie", "IA très facile", "IA facile", "IA ça va encore",
				"IA faut voir ton niveau","IA ça commence à chatouiller hein ?!","IA ah bah oui il faut s'entraîner aussi",
				"IA tu le retentes tu es sûr ?","IA non mais abandonne !","IA HAHAHAHAHAHA (rire démoniaque)"};
